pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://34.197.146.143:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/wraith-klu/fullstackAppForAWS.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://34.197.146.143:9090/springapp1"
            echo "✅ Frontend deployed: http://34.197.146.143:9090/frontapp1"
        }
        failure {
